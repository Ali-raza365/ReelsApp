...
// export const BASE_URL = "https://reelvibe-server.com";

export const CHECK_USERNAME = `${BASE_URL}/oauth/check-username`;
export const REGISTER = `${BASE_URL}/oauth/register`;
export const EMAIL_REGISTER = `${BASE_URL}/oauth/email-register`;
...
export const GIPHY_API_KEY = 'JZIseC4kuhlVG3tu6fkVboGjxSAFNJFG';
